export const copy = {
  ...
  teamExtras: {
    ...
    headline: "Therapy dogs on staff at Badlands TMS",
    items: [
      {
        name: "Chewy",
        role: "Superchill Dog",
        body: "Chewy has been a therapy dog since 2014. We believe he is a black Lab/Husky/Rottweiler mix — an extremely loving dog that likes to lie on your feet and go right into REM sleep.",
        image: "/images/chewy.jpg",
      },
      {
        name: "Millie",
        role: "Smile Generator",
        body: "Millie is the tiniest of our therapy dogs. When she's at work, Millie has a calm energy that brings a sense of peace to all who meet her.",
