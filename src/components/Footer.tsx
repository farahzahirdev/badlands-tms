...
export function Footer() {
  ...
  return (
    <footer className="border-t border-bl-charcoal/8 bg-gradient-to-b from-white to-bl-mist pb-24 sm:pb-8">
      <div className="mx-auto max-w-content px-4 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
              ...
              <ul className="space-y-3.5">
                <li>
                  ...
                  >
                    ...
                    <span className="pt-1.5 leading-snug sm:pt-0">{site.phone}</span>
                  </a>
                </li>
                <li>
                  <a
        ...
        <div className="mt-10 rounded-card border border-bl-charcoal/8 bg-white/80 px-5 py-5 shadow-soft sm:px-6">
          <p className="text-xs leading-relaxed text-bl-slate">{copy.footer.notEmergency}</p>
          <p className="mt-2 text-xs leading-relaxed text-bl-slate/90">{copy.footer.disclaimer}</p>
          <p className="mt-2 text-xs leading-relaxed text-bl-slate/90">{copy.footer.oregonNote}</p>
